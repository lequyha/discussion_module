...
class _CommentService implements CommentService {
  ...
  Future<HttpResponse<BaseResponseModel<CommentModel>>> getAllNotifications({
    ...
    final _options =
        _setStreamType<HttpResponse<BaseResponseModel<CommentModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/load?objectId=${objectId}&objectType=${objectType.name}',
    ...
    late BaseResponseModel<CommentModel> _value;
    try {
      _value = BaseResponseModel<CommentModel>.fromJson(
        _result.data!,
